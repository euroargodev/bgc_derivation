...
%
%    nitrate = nitproc(profvarnams, profvarids, profids, coefs)
%  where
...
%    nitrate        is a vector of calculated nitrate values generated based on the
%                   provided data
%

% title - s nitproc vr - 1.0 author - bodc/matcaz date - 2021-04-26
%
% mods -
%
nc = profids(1);
