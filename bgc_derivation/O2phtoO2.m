...
Pcorr=1+((stc.Pcoef2*TEMP_DOXY+stc.Pcoef3).*PRES)/1000; 
TS=log((298.15-TEMP_DOXY)./(273.15+TEMP_DOXY));

pH2O=1013.25*exp(stc.D0+stc.D1*(100./(TEMP_DOXY+273.15))+...
     stc.D2*log((TEMP_DOXY+273.15)/100)+stc.D3*PSAL); 
